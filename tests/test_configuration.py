...
from dirdigest.utils import (
    config as dirdigest_config,  # To access DEFAULT_CONFIG_FILENAME
)
...
class TestConfigLoadingAndMerging:
    ...
    def test_load_default_config_file_name(
        ...
        mock_md_format,
        mock_build_tree,
        mock_process_dir,  # Order of mocks
        runner: CliRunner,
        temp_test_dir: Path,
    ):
        """
    ...
    def test_cli_overrides_default_config_file(
        ...
        Description: Verifies that CLI arguments take precedence over settings in the default '.dirdigest' file.
        """
        config_content = {
            "default": {
